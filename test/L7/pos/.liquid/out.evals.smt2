...
(pop 1)
(push 1)
(assert (and (= VV$35$6 xs$39$) (>= (apply$35$$35$20 (as len Int) VV$35$6) 0)))
(assert (and (= VV$35$6$35$$35$4 xs$39$) (>= (apply$35$$35$20 (as len Int) VV$35$6$35$$35$4) 0)))
(assert (>= (apply$35$$35$20 (as len Int) xs$39$) 0))
(assert (>= (apply$35$$35$20 (as len Int) xs$35$1) 0))
(assert (>= (apply$35$$35$20 (as len Int) ys) 0))
(assert (and (= (apply$35$$35$20 (as len Int) xs$35$3) (+ 1 (apply$35$$35$20 (as len Int) xs$39$))) (>= (apply$35$$35$20 (as len Int) xs$35$3) 0)))
(pop 1)
(pop 1)
