...
(declare-fun VV$35$6$35$$35$4 () (list Int))
...
(declare-fun smt_lambda$35$$35$9 (Bool (list Int)) Int)
(declare-fun smt_lambda$35$$35$10 (Str Int) Int)
(declare-fun smt_lambda$35$$35$1 (Int Bool) Int)
(declare-fun smt_lambda$35$$35$4 (Int (list Int)) Int)
(declare-fun smt_lambda$35$$35$8 (Bool (_ BitVec 32)) Int)
(declare-fun smt_lambda$35$$35$23 ((list Int) (_ BitVec 32)) Int)
...
(push 1)
(assert (and (= (apply$35$$35$20 (as len Int) v$35$$35$1) 0) (= (apply$35$$35$20 (as len Int) v) 0)))
(push 1)
(assert (not (>= (apply$35$$35$20 (as len Int) v$35$$35$1) 0)))
(check-sat)
; SMT Says: Unsat
(pop 1)
(pop 1)
(push 1)
(assert (and (= (apply$35$$35$20 (as len Int) v$35$1$35$$35$2) (+ 1 (apply$35$$35$20 (as len Int) xs))) (>= (apply$35$$35$20 (as len Int) xs) 0) (= (apply$35$$35$20 (as len Int) v$35$1) (+ 1 (apply$35$$35$20 (as len Int) xs)))))
(push 1)
(assert (not (>= (apply$35$$35$20 (as len Int) v$35$1$35$$35$2) 0)))
(check-sat)
; SMT Says: Unsat
(pop 1)
(pop 1)
(push 1)
(assert (and (>= (apply$35$$35$20 (as len Int) ys) 0) (and (= VV$35$6$35$$35$4 xs$39$) (>= (apply$35$$35$20 (as len Int) VV$35$6$35$$35$4) 0)) (>= (apply$35$$35$20 (as len Int) xs$39$) 0) (and (= (apply$35$$35$20 (as len Int) xs$35$3) (+ 1 (apply$35$$35$20 (as len Int) xs$39$))) (>= (apply$35$$35$20 (as len Int) xs$35$3) 0)) (and (= VV$35$6 xs$39$) (>= (apply$35$$35$20 (as len Int) VV$35$6) 0)) (>= (apply$35$$35$20 (as len Int) xs$35$1) 0)))
(push 1)
(assert (not (and (<= 0 (+ (apply$35$$35$20 (as len Int) ys) (apply$35$$35$20 (as len Int) VV$35$6$35$$35$4))) (< (+ (apply$35$$35$20 (as len Int) ys) (apply$35$$35$20 (as len Int) VV$35$6$35$$35$4)) (+ (apply$35$$35$20 (as len Int) xs$35$3) (apply$35$$35$20 (as len Int) ys))))))
(check-sat)
; SMT Says: Unsat
(pop 1)
(pop 1)
